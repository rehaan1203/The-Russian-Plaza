...
<style>
    ...
    ul {
        ...
        box-shadow: 0 10px 20px rgba(0, 0, 0, 0.19); /* Added box shadow */
    }
    li {
        color: white;
    }
    ...
    <div style="margin-left:25%;padding:1px 16px;height:1000px;">
        <p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
            <table class="basic_box">
                <tr>
                    <th colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Admin Room Status</b></p></th>
                </tr>
                <tr>
                    <th>Booking ID</th>
                    <th>Name</th>
